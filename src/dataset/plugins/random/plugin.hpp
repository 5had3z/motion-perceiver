...
public:
    inline explicit MixedRandomGenerator(const dali::OpSpec& spec)
        ...
        , mCount{std::max(spec.GetArgument<int64_t>("n_random"), 0L)} // Won't accept zero default because nullptr
        , mMin{spec.GetArgument<int64_t>("min")}
        , mMax{spec.GetArgument<int64_t>("max")}
        , mStride{spec.GetArgument<int64_t>("stride")}
        , mSeed{spec.GetArgument<int64_t>("seed")} // Seed is randomly generated by DALI
    {
